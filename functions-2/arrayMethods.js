...
// CODE HERE
const evenNumbers  = mixedNumbers.filter( (evens) => evens % 2 ===0)
...
// CODE HERE
const postTaxPrices  = prices.map( (pretax) => {return pretax*1.07});
...
let sum = c.reduce( (prev_value, curr_value) => {
...
// CODE HERE
const totalPopulation   = populations.reduce((pops, nextpops) => {return pops+nextpops})
...
// CODE HERE
const myStrongest  = monstersInYourPocket.filter( (m) => m.CP>200);
