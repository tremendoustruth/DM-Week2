...
class Manager extends Employee {
    ...
    addEmployee(emp) {
        ...
        console.log(`The new employee list is ${this.employees}`)
    }
}
...
//CODE HERE
let manager = new Manager("Winston", "weekdays", ["Cece", "Schmidt"]);
console.log(manager);
/*
...
//CODE HERE
manager.getEmployees(); //confirmed